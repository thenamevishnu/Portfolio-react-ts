    ...
    return (
        <div className='text-white'>
            ...
            <div className='text-center mt-6'>
                ...
                <button className='outline-none bg-gray-800 p-2 rounded-xl hover:bg-gray-700 mr-3' onClick={()=>window.open("tel:918943362723","_blank")}><i className='fa fa-phone'></i> Phone</button>
